...
interface PaymentRepository {
    ...
    suspend fun addCard(addCardRequest: AddCardRequest) : Response<CardOperationResponse>
    suspend fun editCard(editCardRequest: EditCardRequest) : Response<CardOperationResponse>
    suspend fun deleteCard(deleteCardRequest: DeleteCardRequest) : Response<CardOperationResponse>
