...
//import com.example.sportikitochka.ui.credit_card_view.animations.Animation
//import com.example.sportikitochka.ui.credit_card_view.animations.RotationAnimation
//import com.example.sportikitochka.ui.credit_card_view.extensions.getDimensionFontSize
//import com.example.sportikitochka.ui.credit_card_view.extensions.getXmlOrNull
//import com.example.sportikitochka.ui.credit_card_view.extensions.px
//import com.example.sportikitochka.ui.credit_card_view.extensions.setSizes
...
//import com.example.sportikitochka.ui.credit_card_view.models.CardInput
//import com.example.sportikitochka.ui.credit_card_view.models.CreditCard
//import com.example.sportikitochka.ui.credit_card_view.models.TouchGrid
//import com.example.sportikitochka.ui.credit_card_view.util.Expiry
//import com.example.sportikitochka.ui.credit_card_view.util.Filler
//import com.example.sportikitochka.ui.credit_card_view.util.NumberFormat
...
// */
//class MyCreditCardView : LinearLayout {
//    /**
...
//    private var cardNumberError: TextView
//    private var cardHolder: TextView
//    private var cardHolderError: TextView
//    private var cardHolderLabel: TextView
//    private var cardCvv: TextView
//    private var cardCvvError: TextView
//    private var cardExpiry: TextView
//    private var cardExpiryError: TextView
//    private var cardExpiryLabel: TextView
//    private var cardBack: ConstraintLayout
//    private var cardFront: ConstraintLayout
//    private var cardFrontLogo: ImageView
//    private var cardBackLogo: ImageView
//    private var cardSignStrip: View
//    private var cardMagneticStrip: View
//
//
//
//    var number: String
...
//        cardExpiryError = findViewById(R.id.cardExpiryError)
//        cardExpiryLabel = findViewById(R.id.cardExpiryLabel)
//        cardBack = findViewById(R.id.cardBack)
//        cardFront = findViewById(R.id.cardFront)
//        cardFrontLogo = findViewById(R.id.cardFrontLogo)
//        cardBackLogo = findViewById(R.id.cardBackLogo)
//        cardSignStrip = findViewById(R.id.cardSignStrip)
//        cardMagneticStrip = findViewById(R.id.cardMagneticStrip)
//
//
...
//                when {
//                    contentEquals(intArrayOf(0, 0)) -> callback(this@MyCreditCardView, CardArea.TOP_LEFT)
//                    contentEquals(intArrayOf(1, 0)) -> callback(this@MyCreditCardView, CardArea.TOP_CENTER)
//                    contentEquals(intArrayOf(2, 0)) -> callback(this@MyCreditCardView, CardArea.TOP_RIGHT)
//                    contentEquals(intArrayOf(0, 1)) -> callback(this@MyCreditCardView, CardArea.CENTER_LEFT)
//                    contentEquals(intArrayOf(1, 1)) -> callback(this@MyCreditCardView, CardArea.CENTER)
//                    contentEquals(intArrayOf(2, 1)) -> callback(this@MyCreditCardView, CardArea.CENTER_RIGHT)
//                    contentEquals(intArrayOf(0, 2)) -> callback(this@MyCreditCardView, CardArea.BOTTOM_LEFT)
//                    contentEquals(intArrayOf(1, 2)) -> callback(this@MyCreditCardView, CardArea.BOTTOM_CENTER)
//                    contentEquals(intArrayOf(2, 2)) -> callback(this@MyCreditCardView, CardArea.BOTTOM_RIGHT)
//                }
//            }
//
...
//                when {
//                    contentEquals(intArrayOf(0, 0)) -> callback(this@MyCreditCardView, CardArea.TOP)
//                    contentEquals(intArrayOf(0, 1)) -> callback(this@MyCreditCardView, CardArea.BOTTOM)
//                }
//            }
//
...
//                when {
//                    contentEquals(intArrayOf(0, 0)) -> callback(this@MyCreditCardView, CardArea.LEFT)
//                    contentEquals(intArrayOf(1, 0)) -> callback(this@MyCreditCardView, CardArea.RIGHT)
//                }
//            }
//        }
//
...
//
//    /**
//     * Sets an [AreaClickListener] for this [MyCreditCardView], this listener
...
//                currentStyle = style
//
//                context.obtainStyledAttributes(style, R.styleable.MyCreditCardView).use { array ->
//                    onStyle(array)
//                }
//            }
//        }
...
//
//            context.obtainStyledAttributes(styleRes, R.styleable.MyCreditCardView).use {
//                onStyle(it)
//            }
//        }
//    }
...
//                R.styleable.MyCreditCardView_cardFrontBackground
//            )
//            cardBack.background = getDrawable(
//                R.styleable.MyCreditCardView_cardBackBackground
//            )
//            cardFrontLogo.setImageDrawable(
//                getDrawable(
//                    R.styleable.MyCreditCardView_cardFrontLogo
//                )
//            )
//            cardBackLogo.setImageDrawable(
//                getDrawable(
//                    R.styleable.MyCreditCardView_cardBackLogo
//                )
//            )
//            cardFrontLogo.setSizes(
//                getDimensionPixelSize(
//                    R.styleable.MyCreditCardView_cardFrontLogoSize,
//                    LOGO_FRONT
//                )
//            )
//            cardBackLogo.setSizes(
//                getDimensionPixelSize(
//                    R.styleable.MyCreditCardView_cardBackLogoSize,
//                    LOGO_BACK
//                )
//            )
//            cardCvv.background = getDrawable(
//                R.styleable.MyCreditCardView_cvvBackground
//            )
//            cardSignStrip.background = getDrawable(
//                R.styleable.MyCreditCardView_signStripBackground
//            )
//            cardMagneticStrip.background = getDrawable(
//                R.styleable.MyCreditCardView_magneticStripBackground
//            )
//
//            numberFillers = getXmlOrNull(R.styleable.MyCreditCardView_cardNumberFillers) {
//                Filler.parseList(it)
//            } ?: numberFillers
//            cvvFillers = getXmlOrNull(R.styleable.MyCreditCardView_cardCvvFillers) {
//                Filler.parseList(it)
//            } ?: cvvFillers
//            numberFormat = NumberFormat(
//                getString(R.styleable.MyCreditCardView_cardNumberFormat) ?: numberFormat?.format
//            )
//            textColor = getColor(R.styleable.MyCreditCardView_cardTextColor, textColor)
//            textSize = getDimensionFontSize(R.styleable.MyCreditCardView_cardTextSize, textSize)
//            labelColor = getColor(R.styleable.MyCreditCardView_cardLabelColor, labelColor)
//            labelSize = getDimensionFontSize(R.styleable.MyCreditCardView_cardLabelSize, labelSize)
//            errorColor = getColor(R.styleable.MyCreditCardView_cardLabelColor, errorColor)
//            errorSize = getDimensionFontSize(R.styleable.MyCreditCardView_cardLabelSize, errorSize)
//            hintColor = getColor(R.styleable.MyCreditCardView_cardHintColor, hintColor)
//            holderHint = getString(R.styleable.MyCreditCardView_cardHolderHint) ?: holderHint
//            holderError = getString(R.styleable.MyCreditCardView_cardHolderError) ?: holderError
//            holderLabel = getString(R.styleable.MyCreditCardView_cardHolderLabel) ?: holderLabel
//            numberSize = getDimensionFontSize(R.styleable.MyCreditCardView_cardNumberSize, numberSize)
//            numberError = getString(R.styleable.MyCreditCardView_cardNumberError) ?: numberError
//            numberHint = getString(R.styleable.MyCreditCardView_cardNumberHint) ?: numberHint
//            cvvHint = getString(R.styleable.MyCreditCardView_cardCvvHint) ?: cvvHint
//            cvvError = getString(R.styleable.MyCreditCardView_cardCvvError) ?: cvvError
//            cvvTextColor = getColor(R.styleable.MyCreditCardView_cardCvvTextColor, cvvTextColor)
//            cvvSize = getDimensionFontSize(R.styleable.MyCreditCardView_cardCvvSize, cvvSize)
//            expiryHint = getString(R.styleable.MyCreditCardView_cardExpiryHint) ?: expiryHint
//            expiryError = getString(R.styleable.MyCreditCardView_cardExpiryError) ?: expiryError
//            expiryLabel = getString(R.styleable.MyCreditCardView_cardExpiryLabel) ?: expiryLabel
//            isFlipped = getBoolean(R.styleable.MyCreditCardView_cardIsFlipped, isFlipped)
//            flipOnClick = getBoolean(R.styleable.MyCreditCardView_flipOnClick, flipOnClick)
//            flipOnEdit = getBoolean(R.styleable.MyCreditCardView_flipOnEdit, flipOnEdit)
//            formatExpiry = getBoolean(R.styleable.MyCreditCardView_autoFormatExpiry, formatExpiry)
//
//            if (firstRun) {
//                cvv = getString(R.styleable.MyCreditCardView_cardCvv) ?: cvv
//                expiry = getString(R.styleable.MyCreditCardView_cardExpiry) ?: expiry
//                holder = getString(R.styleable.MyCreditCardView_cardHolder) ?: holder
//                number = getString(R.styleable.MyCreditCardView_cardNumber) ?: number
//            }
//
//        }
//    }
